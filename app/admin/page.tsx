...
const ADMIN_LANGS = {
  en: {
    ...
    monthlyBreakdown: "Monthly breakdown", totalEarned: "Total earned",
    avgPerOrder: "Avg per order", bestMonth: "Best month", delivered: "Delivered",
    month: "Month", orders: "Orders", revenueJPY: "Revenue (JPY)", revenueEUR: "Revenue (EUR)", avgOrder: "Avg/order",
    total: "TOTAL", sources: "Sources", serviceAvg: "service fee avg",
  },
  fr: {
